...
const HeadName = () => <p className="text-sm font-bold text-gray-600 dark:text-white">NAME</p>;
const NameCell = ({ info }: any) => (
	<div className="flex items-center">
		<Checkbox defaultChecked={info.getValue()[1]} color="amber" me="10px" />
		<p className="ml-3 text-sm font-bold text-navy-700 dark:text-white">{info.getValue()[0]}</p>
	</div>
);

const CheckTable = (props: { tableData: any }) => {
